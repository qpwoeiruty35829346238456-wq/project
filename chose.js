...
function good(){
    if(true){
        let newOffer = {
        store_type : document.getElementById("e").value,
        shop_name : document.getElementById("a").value,
        phone : document.getElementById("b").value,
        whatsapp : document.getElementById("c").value,
        salary : document.getElementById("d").value,
